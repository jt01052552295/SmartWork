...
import kr.koogle.android.smartconstruction.util.URLImageParser;
...
public class SmartApprovalViewActivity extends AppCompatActivity {
    ...
    private static RecyclerView recyclerViewDetails;
    private SmartApprovalViewDetailsAdapter detailsAdapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //Toast.makeText(SmartApprovalViewActivity.this, "approvalCode : " + approvalCode + "approvalType : " + approvalType  , Toast.LENGTH_LONG).show();
        // RecyclerView 저장
        recyclerView = (RecyclerView) findViewById(R.id.rv_approval_view_comments);
        // LayoutManager 저장
        layoutManager = new LinearLayoutManager(SmartApprovalViewActivity.this);
        // RecycleView에 LayoutManager 세팅
        recyclerView.setLayoutManager(layoutManager);

        // 업체정보
        recyclerViewDetails = (RecyclerView) findViewById(R.id.rv_approval_view_details);
        layoutManagerDetails = new LinearLayoutManager(SmartApprovalViewActivity.this);
        ...
        layoutManagerSign = new LinearLayoutManager(SmartApprovalViewActivity.this);
        ...
        detailsAdapter = new SmartApprovalViewDetailsAdapter(this, SmartSingleton.arrApprovalDetails);
        ...
        RecyclerView.ItemAnimator itemAnimatorDetail = new DefaultItemAnimator();
        itemAnimatorDetail.setAddDuration(1000);
        itemAnimatorDetail.setRemoveDuration(1000);
        recyclerViewDetails.setItemAnimator(itemAnimatorDetail);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SmartApprovalViewActivity.this.finish();
            }
        });
                ...
                call.enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        try {
                            ...
                            new MaterialDialog.Builder(SmartApprovalViewActivity.this)
                                    .title("결재 완료")
    ...
    private void addRows(){
        ...
        call.enqueue(new Callback<SmartApproval>() {
            ...
            public void onResponse(Call<SmartApproval> call, Response<SmartApproval> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if(SmartSingleton.smartApproval.intId != 0){
                        ...
                        _txtCate2.setText(SmartSingleton.smartApproval.strCate2);
                        ...
                        Log.e(TAG, " strNowSign " + SmartSingleton.smartApproval.strNowSign + " : " + pref.getValue("pref_user_code", "") + " - "+ SmartSingleton.smartApproval.intLevel);
                        ...
                        // 업체정보 어댑터 갱신
                        SmartSingleton.arrApprovalDetails.addAll(SmartSingleton.smartApproval.arrApprovalDetails);
                        ...
                        Toast.makeText(SmartApprovalViewActivity.this, "데이터가 정확하지 않습니다." , Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<SmartApproval> call, Throwable t) {
                Toast.makeText(SmartApprovalViewActivity.this, "네트워크 상태가 좋지 않습니다!" , Toast.LENGTH_LONG).show();
