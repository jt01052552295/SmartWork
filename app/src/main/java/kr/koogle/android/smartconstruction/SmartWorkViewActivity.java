...
public class SmartWorkViewActivity extends AppCompatActivity {
    ...
    @Bind(R.id.txt_work_view_build_name)
    TextView _txtBuildName;
    @Bind(R.id.txt_work_view_date)
    TextView _txtDate;
    @Bind(R.id.txt_work_view_weather)
    TextView _txtWeather;
    @Bind(R.id.txt_work_view_memo)
    TextView _txtMemo;

    @Bind(R.id.btn_work_view_delete)
    ImageView _btnDelete;
    @Bind(R.id.btn_work_view_add_labor)
    ImageView _btnAddLabor;
    @Bind(R.id.btn_work_view_add_material)
    ImageView _btnAddMaterial;
    @Bind(R.id.btn_work_view_add_equipment)
    ImageView _btnAddEquipment;
    @Bind(R.id.btn_work_view_add_memo)
    ImageView _btnAddMemo;
    @Bind(R.id.btn_work_view_add_photo)
    ImageView _btnAddPhoto;

    // row_work_view_labor
    @Bind(R.id.ll_work_view_add_labor)
    LinearLayout _llWorkViewAddLabor;
    @Bind(R.id.txt_work_view_labor_cate1)
    TextView _txtWorkViewLaborCate1;
    @Bind(R.id.txt_work_view_labor_cate2)
    TextView _txtWorkViewLaborCate2;
    @Bind(R.id.txt_work_view_labor_count)
    EditText _txtWorkViewLaborCount;
    @Bind(R.id.txt_work_view_labor_unit)
    TextView _txtWorkViewLaborUnit;
    @Bind(R.id.txt_work_view_labor_memo)
    EditText _txtWorkViewLaborMemo;
    @Bind(R.id.btn_work_view_labor_add)
    ImageView _btnWorkViewLaborAdd;

    // row_work_view_material
    @Bind(R.id.ll_work_view_add_material)
    LinearLayout _llWorkViewAddMaterial;
    @Bind(R.id.txt_work_view_material_cate1)
    TextView _txtWorkViewMaterialCate1;
    @Bind(R.id.txt_work_view_material_cate2)
    TextView _txtWorkViewMaterialCate2;
    @Bind(R.id.txt_work_view_material_count)
    EditText _txtWorkViewMaterialCount;
    @Bind(R.id.txt_work_view_material_unit)
    TextView _txtWorkViewMaterialUnit;
    @Bind(R.id.txt_work_view_material_memo)
    EditText _txtWorkViewMaterialMemo;
    @Bind(R.id.btn_work_view_material_add)
    ImageView _btnWorkViewMaterialAdd;

    // row_work_view_equipment
    @Bind(R.id.ll_work_view_add_equipment)
    LinearLayout _llWorkViewAddEquipment;
    @Bind(R.id.txt_work_view_equipment_cate1)
    TextView _txtWorkViewEquipmentCate1;
    @Bind(R.id.txt_work_view_equipment_cate2)
    TextView _txtWorkViewEquipmentCate2;
    @Bind(R.id.txt_work_view_equipment_count)
    EditText _txtWorkViewEquipmentCount;
    @Bind(R.id.txt_work_view_equipment_unit)
    TextView _txtWorkViewEquipmentUnit;
    @Bind(R.id.txt_work_view_equipment_memo)
    EditText _txtWorkViewEquipmentMemo;
    @Bind(R.id.btn_work_view_equipment_add)
    ImageView _btnWorkViewEquipmentAdd;
            ...
            public void onClick(View view) {
                ...
                if (!SmartSingleton.arrSmartBuilds.isEmpty()) {
                    ...
                    for (int i = 0; i < SmartSingleton.arrSmartBuilds.size(); i++) {
                        if(SmartSingleton.arrSmartBuilds.get(i).intLevel == 1){
                            arrBuild.add(SmartSingleton.arrSmartBuilds.get(i).strName);
                            Log.e(TAG, SmartSingleton.arrSmartBuilds.get(i).strName);
                        }
                    }
                }
