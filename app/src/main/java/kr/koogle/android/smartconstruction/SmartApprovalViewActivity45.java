...
public class SmartApprovalViewActivity45 extends AppCompatActivity {
    ...
    @Bind(R.id.txt_approval_view_detail_date1) TextView _txtDetailDate1;
    @Bind(R.id.txt_approval_view_detail_costYN) TextView _txtDetailCostYN;
    @Bind(R.id.txt_approval_view_detail_bank) TextView _txtDetailBank;
    @Bind(R.id.txt_approval_view_detail_bankNum) TextView _txtDetailBankNum;
    @Bind(R.id.txt_approval_view_detail_bankName) TextView _txtDetailBankName;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approval_view45);
        ...
        //Toast.makeText(SmartApprovalViewActivity45.this, "approvalCode : " + approvalCode + "approvalType : " + approvalType  , Toast.LENGTH_LONG).show();
        Log.e(TAG, "approvalCode : " + approvalCode + "approvalType : " + approvalType);
        // RecyclerView 저장
        recyclerView = (RecyclerView) findViewById(R.id.rv_approval_view_comments);
        // LayoutManager 저장
        layoutManager = new LinearLayoutManager(SmartApprovalViewActivity45.this);
        ...
        layoutManagerSign = new LinearLayoutManager(SmartApprovalViewActivity45.this);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SmartApprovalViewActivity45.this.finish();
            }
        });
                ...
                call.enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        try {
                            ...
                            new MaterialDialog.Builder(SmartApprovalViewActivity45.this)
                                    .title("결재 완료")
    ...
    private void addRows(){
        ...
        call.enqueue(new Callback<SmartApproval>() {
                ...
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if(SmartSingleton.smartApproval.intId != 0){
                        ...
                        if(SmartSingleton.smartApproval.strCost1 != "") {
                            ...
                            Double price1 = Double.parseDouble(SmartSingleton.smartApproval.strCost1);
                        ...
                        if(SmartSingleton.smartApproval.strCost2 != "") {
                            NumberFormat nf = NumberFormat.getInstance();
                            Double price2 = Double.parseDouble(SmartSingleton.smartApproval.strCost2);
                        ...
                        if(SmartSingleton.smartApproval.strCost3 != "") {
                            NumberFormat nf = NumberFormat.getInstance();
                            Double price3 = Double.parseDouble(SmartSingleton.smartApproval.strCost3);
                        ...
                        _txtReturn.setText(SmartSingleton.smartApproval.strReturn);
                        ...
                        if(SmartSingleton.smartApproval.arrApprovalDetails.size() == 0){
                            ...
                            _txtDetailDate1.setText("");
                            _txtDetailCostYN.setText("");
                            _txtDetailBank.setText("");
                            _txtDetailBankNum.setText("");
                            _txtDetailBankName.setText("");
                            ...
                            _txtDetailDate1.setText(SmartSingleton.smartApproval.arrApprovalDetails.get(0).strDate1);
                            if (SmartSingleton.smartApproval.arrApprovalDetails.get(0).strCostYN.equals("Y")) {
                                _txtDetailCostYN.setText("포함(세금계산서 발행)");
                            } else {
                                _txtDetailCostYN.setText("미포함(세금계산서 미발행)");
                            }
                            _txtDetailBank.setText(SmartSingleton.smartApproval.arrApprovalDetails.get(0).strBank);
                            _txtDetailBankNum.setText(SmartSingleton.smartApproval.arrApprovalDetails.get(0).strBankNum);
                            _txtDetailBankName.setText(SmartSingleton.smartApproval.arrApprovalDetails.get(0).strBankName);

                        }

                        String[] arr_signDate   = SmartSingleton.smartApproval.strSignDate.split("\\|");
                        _txtSign1.setText("담당자");
                        Log.e(TAG, " 담당자 strId " + SmartSingleton.smartApproval.strId );
                        // 담당자 서명
                        ...
                        Toast.makeText(SmartApprovalViewActivity45.this, "데이터가 정확하지 않습니다." , Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<SmartApproval> call, Throwable t) {
                Toast.makeText(SmartApprovalViewActivity45.this, "네트워크 상태가 좋지 않습니다!" , Toast.LENGTH_LONG).show();
    ...
    private void docBack(int intId){
        ...
        startActivityForResult(intext, 11011);
    }
