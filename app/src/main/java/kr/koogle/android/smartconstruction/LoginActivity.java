...
public class LoginActivity extends AppCompatActivity {
    ...
    @Bind(R.id.btn_test_login) Button _testLoginButton;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        _testLoginButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                demo_login();
            }
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if (response.isSuccessful() && response.body() != null ) {
                    ...
                    pref.put("pref_user_domain", user.getPref_user_domain());
                    pref.put("pref_access_token", basicToken);
                    pref.put("pref_app_menu1", user.getPref_app_menu1());
                    pref.put("pref_app_menu2", user.getPref_app_menu2());
                    pref.put("pref_app_menu3", user.getPref_app_menu3());
                    pref.put("pref_app_menu4", user.getPref_app_menu4());
                    pref.put("pref_app_menu1_chk", user.getPref_app_menu1_chk());
                    pref.put("pref_app_menu2_chk", user.getPref_app_menu2_chk());
                    pref.put("pref_app_menu3_chk", user.getPref_app_menu3_chk());
                    pref.put("pref_app_menu4_chk", user.getPref_app_menu4_chk());
    ...
    public void demo_login() {
        final String email = "test1";
        final String password = "12341234";
        Log.d(TAG, "Login : " + email + "/" + password);

        _testLoginButton.setEnabled(false);
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                ...
                if (response.isSuccessful() && response.body() != null ) {
                    ...
                    Log.e(TAG, "getLoginToken - pref_access_token : " + basicToken);
                    pref.put("pref_user_code", user.getPref_user_code());
                    pref.put("pref_user_id", user.getPref_user_id());
                    pref.put("pref_user_name", user.getPref_user_name());
                    pref.put("pref_user_type", user.getPref_user_type());
    ...
    public boolean validate() {
        ...
        if (password.isEmpty() || password.length() < 4 || password.length() > 15) {
            _passwordText.setError("4자 이상 15자 이하의 비밀번호를 입력하세요!");
            valid = false;
        } else {
