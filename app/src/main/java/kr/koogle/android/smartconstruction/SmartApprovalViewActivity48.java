...
public class SmartApprovalViewActivity48 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_approval_view48);
        ...
        //Toast.makeText(SmartApprovalViewActivity48.this, "approvalCode : " + approvalCode + "approvalType : " + approvalType  , Toast.LENGTH_LONG).show();
        // RecyclerView 저장
        recyclerView = (RecyclerView) findViewById(R.id.rv_approval_view_comments);
        // LayoutManager 저장
        layoutManager = new LinearLayoutManager(SmartApprovalViewActivity48.this);
        // RecycleView에 LayoutManager 세팅
        recyclerView.setLayoutManager(layoutManager);

        // 결재사인
        recyclerViewSign = (RecyclerView) findViewById(R.id.rv_approval_view_sign);
        layoutManagerSign = new LinearLayoutManager(SmartApprovalViewActivity48.this);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SmartApprovalViewActivity48.this.finish();
            }
        });
                ...
                call.enqueue(new Callback<ResponseBody>() {
                    ...
                    public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                        try {
                            ...
                            new MaterialDialog.Builder(SmartApprovalViewActivity48.this)
                                    .title("결재 완료")
    ...
    private void addRows(){
        ...
        call.enqueue(new Callback<SmartApproval>() {
            ...
            public void onResponse(Call<SmartApproval> call, Response<SmartApproval> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    if(SmartSingleton.smartApproval.intId != 0){
                        ...
                        Toast.makeText(SmartApprovalViewActivity48.this, "데이터가 정확하지 않습니다." , Toast.LENGTH_LONG).show();
            ...
            public void onFailure(Call<SmartApproval> call, Throwable t) {
                Toast.makeText(SmartApprovalViewActivity48.this, "네트워크 상태가 좋지 않습니다!" , Toast.LENGTH_LONG).show();
